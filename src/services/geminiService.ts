...
class GeminiService {
  ...
  async generateImageSearchTerms(): Promise<string[]> {
    const prompt = `
    Tạo 5 từ khóa tìm kiếm ảnh bằng tiếng Anh liên quan đến chủ đề "Nhà nước xã hội chủ nghĩa".
        ...
        questions: [
          {
            ...
            options: [
              ...
              "B. Nhà nước của chính phủ",
              "C. Nhà nước của tầng lớp giàu có",
              "D. Nhà nước không có luật pháp",
            ],
            correctAnswer: 0,
            explanation:
              "Nhà nước xã hội chủ nghĩa là nhà nước do nhân dân làm chủ, quản lý và phục vụ lợi ích của toàn dân.",
            difficulty,
          },
        ],
        timeLimit: 60,
